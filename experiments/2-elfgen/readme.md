...
i'm going to regret this rebit hole but yes
...
let's not worry about the code
we have
- elf header (yellow)
- program header (blue)
...
simple the section headers are not really relevant for the executables (unless we talk linking)
